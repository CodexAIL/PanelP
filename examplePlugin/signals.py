...
# This plugin respond to an event after Popo PowerPanel core finished deleting a website.
# Original request object is passed, body can be accessed with request.body.

# If any Event handler returns a response object, Popo PowerPanel will stop further processing and returns your response to browser.
