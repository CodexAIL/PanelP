...
class TestUserManagement(TestCase):
    ...
    def test_submitUserCreation(self):
        ...
        data_ret = {'firstName': 'Usman', 'lastName': 'Nasir', 'email': 'sanyog@madpopo.com', 'userName': 'usman',
    ...
    def test_saveModifications(self):
        ...
        data_ret = {'accountUsername': 'usman','firstName': 'Rehan', 'lastName': 'Nasir', 'email': 'sanyog@madpopo.com',
