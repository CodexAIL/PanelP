...
if [ -z "$XDG_CURRENT_DESKTOP" ]; then
    ...
    echo -e "\nPopoPanel is supported on server OS types only. Such as Ubuntu 18.04 x86_64, Ubuntu 20.04 x86_64, Ubuntu 20.10 x86_64, CentOS 7.x, CentOS 8.x, AlmaLinux 8.x and CloudLinux 7.x...\n"
    exit
fi
...
echo -e "\nPopoPanel source code downloaded...\n"
