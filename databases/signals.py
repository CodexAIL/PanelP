...
## This event is fired before Popo PowerPanel core load the create database template, this special event is used
...
## This event is fired before Popo PowerPanel core start creation of a database.
preSubmitDBCreation = Signal(providing_args=["request"])

## This event is fired after Popo PowerPanel core finished creation of a database.
postSubmitDBCreation = Signal(providing_args=["request", "response"])

## This event is fired before Popo PowerPanel core start deletion of a database
preSubmitDatabaseDeletion = Signal(providing_args=["request"])

## This event is fired after Popo PowerPanel core finished deletion of a database.
postSubmitDatabaseDeletion = Signal(providing_args=["request", "response"])

## This event is fired before Popo PowerPanel core start to change a database password.
preChangePassword = Signal(providing_args=["request"])

## This event is fired after Popo PowerPanel core finished changing database password.
