...
## This event is fired before Popo PowerPanel core load the create package template, this special event is used
...
## This event is fired before Popo PowerPanel core start creation a package.
preSubmitPackage = Signal(providing_args=["request"])

## This event is fired after Popo PowerPanel core finished creation of a package.
postSubmitPackage = Signal(providing_args=["request", "response"])

## This event is fired before Popo PowerPanel core start deletion of a package.
preSubmitDelete = Signal(providing_args=["request"])

## This event is fired after Popo PowerPanel core finished deletion of a package.
postSubmitDelete = Signal(providing_args=["request", "response"])

## This event is fired before Popo PowerPanel core start to modify a package.
preSaveChanges = Signal(providing_args=["request"])

## This event is fired after Popo PowerPanel core finished modifying a package.
